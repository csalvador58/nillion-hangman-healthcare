...
export default function SelectCategory({ categories, setSelectedCategory }: SelectCategoryProps) {
  return (
        ...
        return (
          <li key={item} className="col-span-1 min-w-[215px]">
            <button
              ...
              onClick={() => setSelectedCategory(item.charAt(0).toUpperCase() + item.slice(1, item.length))}
            >
